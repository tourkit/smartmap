...
//   GMARemap(int uni, int addr, Struct& s, void* dst) {   this->dest = (char*)dst; }
...
//   float get8(uint8_t* data) {

//     // hard value from console // clean 50.00000%
...
struct Artnet : Buffer {
  ...
  static inline Struct &universe = Struct::create("universe").add<char>("chan",512);
