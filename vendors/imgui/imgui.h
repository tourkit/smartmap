...
namespace ImGui
{
    ...
    IMGUI_API bool          SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0, ImGuiInputTextFlags temp_flags = 0, ImGuiInputTextCallback temp_callback = NULL, void* temp_user_data = NULL);
    IMGUI_API char          SliderScalarN(const char* label, ImGuiDataType data_type, void* p_data, int components, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0, ImGuiInputTextFlags temp_flags = 0, ImGuiInputTextCallback temp_callback = NULL, void* temp_user_data = NULL);
