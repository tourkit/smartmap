...
int main() { 
    ...
    SmartMap::Layer l1(0, 0, sm.basic_fixture, engine.window.width,engine.window.height, SmartMap::Layer::Mode::Free, 2,2);
    // SmartMap::Layer l1(0, 0, sm.basic_fixture, engine.window.width,engine.window.height, SmartMap::Layer::Mode::Grid, 2,2);
